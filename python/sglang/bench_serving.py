...
async def benchmark(
    ...
    mooncake_eviction = {}
    if not flat_mode and getattr(args, "mooncake_master_host", None):
    ...
    bandwidth_metrics = {}
    if not flat_mode and getattr(args, "prefill_metrics_host", None):
